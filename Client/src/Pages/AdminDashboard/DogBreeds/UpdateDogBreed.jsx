...
const UpdateDogBreed = () => {
  const [breedName, setBreedName] = useState("Labrador Retriever");
  const [image, setImage] = useState("https://example.com/labrador.jpg");
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Breed Updated:", { breedName, image, status });
    navigate("/admin/dog-breeds"); // Redirect after update
  };
