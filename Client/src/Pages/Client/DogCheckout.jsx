...
const secretKey = "8gBm/:&EnhH.1/q"; // Should be in .env in production
const productCode = "EPAYTEST";

// Function to generate payment signature
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const fields = {
        ...
        success_url: "http://localhost:8000/api/payments/dog-payment-success",
        failure_url: "http://localhost:8000/api/payments/dog-payment-failure",
