...
export default function NewsletterSection() {
  return (
    <div className="flex justify-center my-16 px-5 md:px-10 lg:px-10 xl:px-[141px]">
      <div className="h-auto w-full bg-[#FFF0D9] rounded-[50px] px-8 py-5 lg:px-24 lg:py-2 flex flex-col lg:flex-row items-center justify-between">
        {/* Image Section (Hidden on Small Screens) */}
        <div className="hidden lg:block">
          <img
            src={Dog}
            alt="Cute dog illustration"
            className="max-h-[380px] lg:max-h-[430px] w-auto"
          />
        </div>
        ...
        <div className="text-center lg:text-left flex flex-col items-center lg:items-start gap-4 lg:gap-4 font-poppins">
          ...
          <div className="w-full flex flex-col items-center lg:items-start gap-8">
            <input
              ...
              className="w-[400px] sm:max-w-[400px] h-[50px] px-4 rounded-[20px] bg-white text-gray-600 shadow-md focus:outline-none lg:h-[60px] lg:text-lg"
            />
